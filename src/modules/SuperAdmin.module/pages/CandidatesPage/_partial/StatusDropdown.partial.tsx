...
const StatusDropdownPartial = () => {
	...
	return (
		<Dropdown
			className='items-center rounded-full border border-zinc-400 py-0 pl-4 dark:!text-zinc-100 '
			color='zinc'>
			...
			<DropdownMenu className='dark:!text-zinc-100' placement='bottom-start'>
