...
import SignUpWithGoogle from './_partial/SignUpWithGoogle';
import SignUpWitLinkedIn from './_partial/SignUpWithLinkedIn';
        ...
        <PageWrapper
            ...
            <div className='mx-auto flex h-full items-center justify-center max-md:col-span-2  max-md:mx-auto'>
                <div className='mr-auto flex max-w-sm flex-col gap-4'>
                    ...
                    <form className='flex w-96 flex-col gap-4' noValidate onSubmit={formik.handleSubmit}> {/* Added onSubmit here */}
                        <div
