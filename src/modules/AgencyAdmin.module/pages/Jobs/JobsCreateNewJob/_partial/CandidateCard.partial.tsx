...
const CandidateCardPartial = ({
  ...
  const isCustomAssigned = objectExistsInArray(
  ...
  return (
    <Card className="bg-zinc-100 dark:bg-zinc-950">
      ...
      <CardFooter className="!justify-start max-md:!justify-center">
        <Button
          rightIcon={isAssigned || isCustomAssigned? "HeroTwiceCheck" : undefined}
          color={isAssigned || isCustomAssigned ? "emerald" : "blue"}
          variant="solid"
          onClick={() => {
            dispatch(
        ...
        >
          {isAssigned || isCustomAssigned ? "Assigned" : "Assign"}
        </Button>
