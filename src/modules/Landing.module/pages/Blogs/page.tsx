...
function BLOG() {
  const { error, rows, search, loading, count } = useSelector((state: RootState) => state.blog.blogPosts)
    ...
    <div className="bg-[#E0E2F4]">
      <section className="mx-auto max-w-[1280px] space-y-4 bg-[#E0E2F4] px-5 py-3 md:px-10 md:py-6 lg:px-14 lg:py-10">
        ...
        >
          <div className="container mx-auto">
            ...
            >
              ...
              <motion.span
                ...
                variants={itemVariants}
              >
                Explore cutting-edge developments and inspiring stories from the world of KoalaByte AI.
              </motion.span>
            </motion.div>
          </div>
          ...
          >
            <Pagination count={count} getListAction={getBlogPosts} limit={9} search={search} />
          </motion.div>
        </motion.section>
