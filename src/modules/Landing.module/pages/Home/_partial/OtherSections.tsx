    ...
    <>
      ...
      >
        <motion.div className="mb-6 md:mb-0 md:w-2/3" variants={slideVariants}>
          ...
          <h2 className="mb-2 mt-2 text-2xl font-medium text-[#010314] md:text-3xl">Why Choose KoalaByte AI?</h2>
          <p className="text-lg text-[#010314]/50">
            Experience the future of recruitment with AI-driven efficiency, seamless automation, and intelligent
            decision-making—all in one platform.
          </p>
        </motion.div>
        <motion.button
        ...
        <div className="flex flex-col gap-8 md:flex-row">
          <motion.div className="md:w-1/2" variants={slideVariants}>
            ...
            <p className="text-lg text-[#515151]">
              KoalaByte ensures a seamless and secure recruitment experience with encrypted data, role-based access, and
              real-time candidate tracking. Effortlessly search, edit, and assign candidates while maintaining a
              scalable and recruiter-friendly workflow.
            </p>
          </motion.div>
          <motion.div className="items-center md:w-1/2" variants={itemVariants}>
            <img src="/assets/frame32.png" alt="frame32" className="w-full rounded-lg" />
          </motion.div>
        </div>
      </motion.section>
      ...
      >
        ...
        >
          <div className="mb-6 md:mb-0">
            <h2 className="mb-2 text-2xl font-medium text-[#010314] md:text-3xl">Latest Case Studies</h2>
            <p className="text-lg text-[#010314]/50">
              Real-world examples showcasing the impact of the Solomon AI concept on businesses.
            </p>
          </div>
        ...
        <motion.div className="grid grid-cols-1 gap-6 md:grid-cols-3" variants={containerVariants}>
          ...
          <motion.div variants={itemVariants}>
            <LatestCard
              ...
              description={"Learn how analytics and AI can optimize your hiring process for better outcomes."}
          ...
          <motion.div variants={itemVariants}>
            <LatestCard
              ...
              description={"Understand how AI is transforming recruitment and improving decision-making."}
            />
          </motion.div>
        </motion.div>
      </motion.section>
      ...
      >
        <motion.div variants={itemVariants}>
          ...
          <h2 className="mb-2 mt-2 text-2xl font-medium text-[#101828] md:text-3xl">Plans that Fit Your Scale</h2>
          <p className="mx-auto mb-8 max-w-2xl text-lg text-[#475467]">
            Find your perfect plan at KolaByte AI. Unlock all premium features to streamline your hiring process.
          </p>
        </motion.div>
