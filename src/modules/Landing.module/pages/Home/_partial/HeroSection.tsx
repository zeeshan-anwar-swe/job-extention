          ...
          <motion.div
            ...
            <motion.div className='w-full md:w-1/2' variants={containerVariants}>
              ...
              <motion.div
                ...
                variants={itemVariants}>
                Koalify revolutionizes recruitment with an AI-powered talking avatar assistant
                —search candidates, manage jobs, and navigate effortlessly using just your voice.
              </motion.div>
            ...
            <motion.div
              className="rounded-4xl relative flex min-h-[400px]  w-full flex-col items-center justify-between rounded-lg bg-[url('./assets/Frame.png')] bg-cover bg-center bg-no-repeat py-6 md:w-4/12 md:py-12"
              variants={containerVariants}>
              {/* Top Text */}
              <motion.div
              ...
              <motion.div
                ...
                <img
                  ...
                  alt='beargif'
                  className='absolute -top-[100px] h-[450px]  object-cover'
                />
              </motion.div>
              {/* Bottom Button */}
              <motion.div
