								...
								<div className='w-full md:w-1/2 '>
									<div className=''>
										...
										<div className='py-5 text-justify text-[#475467] lg:text-lg'>
											...
											talking avatar assistant —search candidates, manage
											jobs, and navigate effortlessly using just your voice.
										</div>
						...
						<div className='flex flex-col md:flex-row'>
							<div className='w-full p-6 md:w-1/2 md:p-8 lg:p-12'>
								...
								<p className='mb-6 text-base text-[#8F8F8F] md:text-lg'>
									KoalaByte AI offers a range of core advantages that set us apart
									in the human resource technology landscape. These advantages are
					...
					<section className='flex flex-col items-center justify-between md:flex-row'>
						<div className='mb-6 md:mb-0 md:w-2/3'>
							...
							<p className='text-lg text-[#010314]/50'>
								Experience the future of recruitment with AI-driven efficiency,
								seamless automation, and intelligent decision-making—all in one
								platform.
							</p>
						</div>
						...
						<div className='flex flex-col gap-8 md:flex-row'>
							<div className='md:w-1/2'>
								...
								<p className='text-lg text-[#515151]'>
									KoalaByte ensures a seamless and secure recruitment experience
									with encrypted data, role-based access, and real-time candidate
									tracking. Effortlessly search, edit, and assign candidates while
									maintaining a scalable and recruiter-friendly workflow.
								</p>
							</div>
					...
					<section className='rounded-lg bg-white/50 p-6 md:p-8'>
						<div className='mb-8 flex flex-col items-start justify-between md:flex-row md:items-center'>
							<div className='mb-6 md:mb-0'>
								...
								<p className='text-lg text-[#010314]/50'>
									Real-world examples showcasing the impact of the Solomon AI
									concept on businesses.
								</p>
							</div>
