...
const contentRoutes: ContentRoutesType = {
  AgencyAdmin: [
    ...
    {
      path: appPages.AgencyAdmin.clientsAppPages.subPages.clientProfileAppPages
        .to,
      element: <ClientProfilePage />,
    },
    ...
    {
      path: appPages.AgencyAdmin.settingAppPages.subPages.subcriptionAppPages
        .to,
  ...
  SuperAdmin: [
    ...
    {
      path: appPages.SuperAdmin.recruiterAppPages.subPages.recruiterProfilePage
        .to,
    ...
    {
      path: appPages.SuperAdmin.clientsAppPages.subPages.clientProfileAppPages
        .to,
