...
const Tooltip: FC<ITooltipProps> = (props) => {
	const { children, className, text, placement, borderWidth, rounded, ...rest } = props;
						...
						{({ ref, style }) => (
							<div
								...
								className={classNames(
									...
									'max-w-xs',
									'border-zinc-500/10 dark:border-white/50 shadow-lg bg-white dark:bg-zinc-900 dark:text-white',
