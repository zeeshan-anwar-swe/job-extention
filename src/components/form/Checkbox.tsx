...
const Checkbox = forwardRef<HTMLInputElement, ICheckboxProps>((props, ref) => {
  ...
  const checkboxVariantClasses =
    checkboxVariants[variant as TCheckboxVariants].general;
  const checkboxValidationsClasses =
    checkboxVariants[variant as TCheckboxVariants].validation;
  ...
  const checkboxDimensionClasses =
    checkboxDimensions[dimension as TCheckboxDimension].general;
  const labelDimensionClasses =
    checkboxDimensions[dimension as TCheckboxDimension].label;
