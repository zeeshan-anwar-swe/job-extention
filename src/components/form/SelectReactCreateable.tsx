...
const SelectReactCreateable: FC<ISelectReactProps> = (props) => {
	const {
		borderWidth,
		className,
		color,
...
SelectReactCreateable.defaultProps = {
...
SelectReactCreateable.displayName = 'Select';

export default SelectReactCreateable;
