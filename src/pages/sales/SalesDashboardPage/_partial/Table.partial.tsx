			...
			<CardBody className='overflow-auto'>
				<Table className='table-fixed max-md:min-w-[70rem]'>
					...
					<TBody>
						<Tr>
							<Td>
								<TableDataPartial title='Jane Cooper' subTitle='janecooper@hotmail' imageUrl='https://pinnacle.works/wp-content/uploads/2022/06/dummy-image.jpg' />
							</Td>
							<Td>
								<TableDataPartial title='Regional Paradigm Technician' subTitle='Client: Phoenix Baker' />
							</Td>
