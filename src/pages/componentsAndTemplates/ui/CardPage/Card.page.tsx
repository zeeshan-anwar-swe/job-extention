...
import CardExample1MD from './md/CardExample1.md';
import CardExample2MD from './md/CardExample2.md';
import CardInterfaceMD from './md/CardInterface.md';
import Dropdown, {
	DropdownItem,
	DropdownMenu,
	DropdownToggle,
				...
				<Doc>
					<DocContent>
						...
						<div className='col-span-12 md:col-span-6'>
							<ExampleView title='Example 1' mdFile={CardExample1MD as RequestInfo}>
								<Card>
									<CardHeader>
										<CardHeaderChild>
						...
						<div className='col-span-12 md:col-span-6'>
							<ExampleView title='Example 2' mdFile={CardExample2MD as RequestInfo}>
						...
						<div
							...
							<Card>
								...
								<CardBody>
									<MdViewer mdFile={CardInterfaceMD as RequestInfo} />
								</CardBody>
							</Card>
						</div>
						<div
