...
import TooltipInterfaceMD from './md/TooltipInterface.md';
import TooltipExample1MD from './md/TooltipExample1.md';
import TooltipExample2MD from './md/TooltipExample2.md';
				...
				<Doc>
					<DocContent>
						...
						<div className='col-span-12 md:col-span-6'>
							<ExampleView
								title='Example 1'
								mdFile={TooltipExample1MD as RequestInfo}>
								<Card>
									<CardBody>
						...
						<div className='col-span-12 md:col-span-6'>
							<ExampleView
								title='Example 2'
								mdFile={TooltipExample2MD as RequestInfo}>
								<Card>
									<CardBody>
										Lorem{' '}
						...
						<div
							...
							<Card>
								...
								<CardBody>
									<MdViewer mdFile={TooltipInterfaceMD as RequestInfo} />
								</CardBody>
							</Card>
						</div>
						<div
