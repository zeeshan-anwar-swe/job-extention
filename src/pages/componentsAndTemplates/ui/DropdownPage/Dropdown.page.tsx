...
import DropdownInterfaceMD from './md/DropdownInterface.md';
import Button from '../../../../components/ui/Button';
import ExampleView from '../../../../templates/for-demo/ExampleView';
import DropdownExample1MD from './md/DropdownExample1.md';
import DropdownExample2MD from './md/DropdownExample2.md';
import DropdownExample3MD from './md/DropdownExample3.md';
import Dropdown, {
	DropdownItem,
	DropdownMenu,
	DropdownNavLinkItem,
				...
				<Doc>
					<DocContent>
						...
						<div className='col-span-12 md:col-span-4'>
							<ExampleView
								title='Example 1'
								mdFile={DropdownExample1MD as RequestInfo}>
								<Card>
									<CardBody>
										<Dropdown>
											<DropdownToggle>
						...
						<div className='col-span-12 md:col-span-4'>
							<ExampleView
								title='Example 2'
								mdFile={DropdownExample2MD as RequestInfo}>
								<Card>
									<CardBody>
										<Dropdown>
						...
						<div className='col-span-12 md:col-span-4'>
							<ExampleView
								title='Example 3'
								mdFile={DropdownExample3MD as RequestInfo}>
								<Card>
									<CardBody>
										<Dropdown>
											<DropdownToggle hasIcon={false}>
						...
						<div
							...
							<Card>
								...
								<CardBody>
									<MdViewer mdFile={DropdownInterfaceMD as RequestInfo} />
								</CardBody>
							</Card>
						</div>
						<div
