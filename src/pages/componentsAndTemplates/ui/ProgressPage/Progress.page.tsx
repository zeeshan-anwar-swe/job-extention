...
import ProgressInterfaceMD from './md/ProgressInterface.md';
import ProgressExample1MD from './md/ProgressExample1.md';
import ProgressExample2MD from './md/ProgressExample2.md';
				...
				<Doc>
					<DocContent>
						...
						<div className='col-span-12 md:col-span-6'>
							<ExampleView
								title='Example 1'
								mdFile={ProgressExample1MD as RequestInfo}>
								<Card>
									<CardBody>
						...
						<div className='col-span-12 md:col-span-6'>
							<ExampleView
								title='Example 2'
								mdFile={ProgressExample2MD as RequestInfo}>
								<Card>
									<CardBody>
										<div className='flex gap-4'>
						...
						<div
							...
							<Card>
								...
								<CardBody>
									<MdViewer mdFile={ProgressInterfaceMD as RequestInfo} />
								</CardBody>
							</Card>
						</div>
						<div
