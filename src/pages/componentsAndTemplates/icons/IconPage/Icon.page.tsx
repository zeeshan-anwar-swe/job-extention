...
import AlertExample1MD from '../../ui/AlertPage/md/AlertExample1.md';
import Card, {
	CardBody,
	CardHeader,
	CardHeaderChild,
...
import IconInterfaceMD from './md/IconInterface.md';
					...
					<DocContent>
						...
						<div
							...
							<Card>
								...
								<CardBody>
									<MdViewer mdFile={IconInterfaceMD as RequestInfo} />
								</CardBody>
							</Card>
						</div>
						<div
