...
import ReactSelectInterfaceMD from './md/ReactSelectInterface.md';
import SelectReactExample1MD from './md/SelectReactExample1.md';
import SelectReactExample2MD from './md/SelectReactExample2.md';
				...
				<Doc>
					<DocContent>
						...
						<div className='col-span-12 md:col-span-6'>
							<ExampleView
								title='Example 1'
								mdFile={SelectReactExample1MD as RequestInfo}>
								<Card>
									<CardBody>
						...
						<div className='col-span-12 md:col-span-6'>
							<ExampleView
								title='Example 2'
								mdFile={SelectReactExample2MD as RequestInfo}>
								<Card>
									<CardBody>
						...
						<div
							...
							<Card>
								...
								<CardBody>
									<MdViewer mdFile={ReactSelectInterfaceMD as RequestInfo} />
								</CardBody>
							</Card>
						</div>
						<div
...
export default SelectReactPage;
