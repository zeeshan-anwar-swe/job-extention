...
import LabelInterfaceMD from './md/LabelInterface.md';
import LabelExample1MD from './md/LabelExample1.md';
import LabelExample2MD from './md/LabelExample2.md';
				...
				<Doc>
					<DocContent>
						...
						<div className='col-span-12 md:col-span-6'>
							<ExampleView title='Example 1' mdFile={LabelExample1MD as RequestInfo}>
								<Card>
									<CardBody>
										<Label
											htmlFor='urlAddress'
						...
						<div className='col-span-12 md:col-span-6'>
							<ExampleView title='Example 2' mdFile={LabelExample2MD as RequestInfo}>
								<Card>
									<CardBody>
						...
						<div
							...
							<Card>
								...
								<CardBody>
									<MdViewer mdFile={LabelInterfaceMD as RequestInfo} />
								</CardBody>
							</Card>
						</div>
					</DocContent>
