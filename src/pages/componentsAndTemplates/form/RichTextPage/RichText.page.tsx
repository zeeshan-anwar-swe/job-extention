...
import RichTextInterfaceMD from './md/RichTextInterface.md';
import RichTextExample1MD from './md/RichTextExample1.md';
				...
				<Doc>
					<DocContent>
						...
						<div className='col-span-12'>
							<ExampleView
								title='Example 1'
								mdFile={RichTextExample1MD as RequestInfo}>
								<Card>
									<CardBody>
						...
						<div
							...
							<Card>
								...
								<CardBody>
									<MdViewer mdFile={RichTextInterfaceMD as RequestInfo} />
								</CardBody>
							</Card>
						</div>
						<div
