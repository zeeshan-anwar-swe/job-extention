...
import SelectInterfaceMD from './md/SelectInterface.md';
import SelectExample1MD from './md/SelectExample1.md';
import SelectExample2MD from './md/SelectExample2.md';
				...
				<Doc>
					<DocContent>
						...
						<div className='col-span-12 md:col-span-6'>
							<ExampleView title='Example 1' mdFile={SelectExample1MD as RequestInfo}>
								<Card>
									<CardBody>
						...
						<div className='col-span-12 md:col-span-6'>
							<ExampleView title='Example 2' mdFile={SelectExample2MD as RequestInfo}>
								<Card>
									<CardBody>
						...
						<div
							...
							<Card>
								...
								<CardBody>
									<MdViewer mdFile={SelectInterfaceMD as RequestInfo} />
								</CardBody>
							</Card>
						</div>
						<div
