...
import CheckboxInterfaceMD from './md/CheckboxInterface.md';
...
import CheckboxExample1MD from './md/CheckboxExample1.md';
import CheckboxExample2MD from './md/CheckboxExample2.md';
import CheckboxExample3MD from './md/CheckboxExample3.md';
				...
				<Doc>
					<DocContent>
						...
						<div className='col-span-12 md:col-span-4'>
							<ExampleView
								title='Example 1'
								mdFile={CheckboxExample1MD as RequestInfo}>
								<Card>
									<CardBody>
						...
						<div className='col-span-12 md:col-span-4'>
							<ExampleView
								title='Example 2'
								mdFile={CheckboxExample2MD as RequestInfo}>
								<Card>
									<CardBody>
										<Label htmlFor='optionA'>Example Checkbox</Label>
										<CheckboxGroup isInline>
						...
						<div className='col-span-12 md:col-span-4'>
							<ExampleView
								title='Example 3'
								mdFile={CheckboxExample3MD as RequestInfo}>
								<Card>
									<CardBody>
						...
						<div
							...
							<Card>
								...
								<CardBody>
									<MdViewer mdFile={CheckboxInterfaceMD as RequestInfo} />
								</CardBody>
							</Card>
						</div>
						<div
